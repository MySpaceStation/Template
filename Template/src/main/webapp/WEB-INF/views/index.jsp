...
<body>
	<jsp:include page="/WEB-INF/views/res/header.jsp"/>
							...
							<div class="carousel-caption">
								...
								<p class="lead inverse">
									{re}<strong>start</strong> is based on <strong>good
										typography</strong> and <strong>large photography</strong>, serving as
									a foundation for your creative projects. Feel free to browse
									its templates and discover its features.
								</p>
					...
					<li class="item"
						...
						<div class="container">
							<div class="carousel-caption">
								...
								<p class="lead inverse">{re}start was built with heavy use
									of {less} technology, making the life of the web developer
									easier!</p>
							</div>
						</div>
					</li>
							...
							<div class="carousel-caption">
								...
								<p class="lead">
									if you are looking for <a href="services.html"><strong>a
											bold approach</strong></a> you will love the header effect,<br /> but
									even if you like <a href="page_alternative.html"><strong>a
		...
		<div id="main">
			<div class="container">
				<section class="call_to_action">
					...
					<a class="btn btn-primary btn-large"
						href="http://www.cssmoban.com/">Buy this theme!</a>
				</section>
			...
			<jsp:include page="/WEB-INF/views/res/footer.jsp" />
		</div>
		<!-- 引入js-->
		<jsp:include page="/WEB-INF/views/res/footer_js/footer_js.jsp" /></body>
</html>