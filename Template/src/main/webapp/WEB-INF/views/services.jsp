				...
				<div class="navbar-inner">
					<a class="brand" href="index.html"> <img
						...
						<span class="logo_subtitle">a clean &amp; multipurpose
							template</span></a> <a class="btn btn-navbar" data-toggle="collapse"
	...
	<div id="main">
		<div class="container">
			<section id="services">
				<div class="hgroup">
					<h1>Services</h1>
					<h2>Nullam eget tortor purus, id molestie sapien. In hac
						habitasse platea dictumst. Donec aliquet tellus enim, a tincidunt
						nulla.</h2>
				...
				<div class="row-fluid service_teaser">
					<div class="span4 teaser_photo">
						<img src="images/der.jpg" alt="a" class="img-rounded" />
					</div>
					<div class="span8">
						<h3>Clean, Responsive Design</h3>
						<p>
							{re}<strong>start</strong> is a multipurpose but <strong>mainly
								business oriented</strong> design, built to serve as a foundation for
							your web projects. It is built upon Bootstrap, a front-end
							development framework with a steep learning curve. It comes with
							a style.less file that tries to use <strong>all the
								power of {less} and bootstrap combined</strong>. Suspendisse nec risus
							fermentum sapien congue fermentum sed at lorem. Fugiat dapibus,
							tellus ac cursus commodo, mauesris condime ntum nibh, ut
							fermentum mas justo.Fugiat dapibus, tellus ac cursus commodo,
							mauesris condime ntum nibh, ut fermentum mas justo.
						</p>
						<p>&nbsp;</p>
						<hr />
						<div class="row-fluid">
							<div class="span6 service">
								...
								<div class="desc span8">
									...
									<p>Fugiat dapibus, tellus ac cursus commodo, mauesris
										condime ntum nibh, ut fermentum mas justo.</p>
								</div>
							</div>
							<div class="span6 service">
								<figure class="span4">
			...
			<div class="row pricing_wrapper">
				<div class="span4">
					<div class="pricing_plan">
						<h3>
							Lite<strong>Plan</strong> <small>this is what you should
								choose</small>
						</h3>
						<div class="the_price">
						...
						<div class="the_offerings">
							<p>
								<strong>1</strong> Design Template
							</p>
							<p>
								<strong>2</strong> Revisions
							</p>
							<p>
								<strong>5</strong> HTML Pages
							</p>
						</div>
						<a href="#" class="btn btn-primary btn-large">Get it Now!</a>
					</div>
				</div>
				<div class="span4">
					<div class="pricing_plan special">
						<h3>
							Medium<strong>Plan</strong> <small>this is what you
								should choose</small>
						</h3>
						<div class="the_price">
							<span>$</span>250<small>/year</small>
						</div>
						<div class="the_offerings">
							<p>
								<strong>1</strong> Design Template
				...
				<div class="span4">
					<div class="pricing_plan">
						<h3>
							Pro<strong>Plan</strong> <small>this is what you should
								choose</small>
						</h3>
						<div class="the_price">
							<span>$</span>350<small>/year</small>
						</div>
						<div class="the_offerings">
							<p>
								<strong>1</strong> Design Template
				...
				<div class="span3 service text-center">
					...
					<div class="desc">
						...
						<p>Fugiat dapibus, tellus ac cursus commodo, mauesris condime
							ntum nibh, ut fermentum mas justo.</p>
					</div>
				</div>
				<div class="span3 service text-center">
					<figure>
