...
<body class="collapsing_header">
	...
	<div class="full_page_photo">
		<iframe width="100%" height="400" frameborder="0" scrolling="no"
			...
			src="http://maps.google.gr/maps?f=q&amp;source=s_q&amp;geocode=&amp;q=london&amp;aq=&amp;sll=40.621192,22.946027&amp;sspn=0.108928,0.264187&amp;ie=UTF8&amp;hq=&amp;&amp;ll=51.517099,-0.146084&amp;spn=0.35721,1.318359&amp;t=m&amp;z=11&amp;output=embed"></iframe>
	</div>
	<div id="main">
		<div class="container">
			<section id="contact">
				...
				<div class="row">
					...
					<div class="span8 contact_form">
						...
						<div class="row">
							<div class="span4">
								<label>Name</label> <input type="text" class="span4" />
							</div>
							<div class="span4">
								<label>E-mail</label> <input type="text" class="span4" />
							</div>
							<div class="span8">
								<label>Subject</label> <input type="text" class="span8" />
							</div>
							<div class="span8">
								<label>Message</label>
							...
							<div class="span8">
								<a class="btn btn-large btn-success"><span>Submit
										Message</span></a>
							</div>
						</div>
						</form>
